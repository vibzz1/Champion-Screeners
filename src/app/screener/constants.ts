...
export const CHIPS = [
  ...
  "range_contraction < 0.85", "vol_contraction < 0.85",
  "offh_50 < 15", "pgo(20) < 20",
  "change > 2", "change < -2",
  "volume > 1000000",
...
export const SCREENER_LS_KEY = "mio_screeners_v9";  // bumped: all scans aligned to MIO formula structure
...
export const DEFAULTS: SavedScreener[] = [
  ...
  { id: "d11", name: "India Pre-Setup Scan", exchange: "NSE", formula: "advol(20) > 100 and advol(50) > 100 and price > sma(50) and price > sma(200) and sma(20) > sma(50) and !(sma(50) trend_dn 20) and !(sma(20) trend_dn 10) and offh_50 < 15 and pgo(20) < 20 and range_contraction < 0.85 and vol_contraction < 0.85" },
